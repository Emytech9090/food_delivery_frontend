...
const SignupPage = () => {
  ...
  return (
    <div className="bg-blue-800/10 inset-0 flex flex-col justify-center items-center h-screen">
      <div className="flex flex-col w-md h-3/4 rounded-lg shadow-xs bg-gray-900 shadow-black text-white items-center px-4 py-4 ">
        ...
        >
          ...
          <Input
            ...
            label="Accept out terms and condition"
            isReversed
          />
          ...
          <p>
            Already signed up?
            <Link to={"/auth/sign-in"} className="text-blue-800 px-2">
              sign in
            </Link>
          </p>
